...
#osascript -e 'tell application "Finder" to set desktop picture to POSIX file "/Users/damian/Pictures/Desktop Pictures/Mountain Vista.jpeg"'
...
# Enable scroll bars to be always shown
...
hdiutil eject  /Volumes/Amphetamine\ Enhancer
rm Amphetamine\ Enhancer.dmg

###############################################################################
# Prevent Start On Lid Open                                                   #
###############################################################################
if [[ "$RUN_AS_ROOT" = true ]]; then
